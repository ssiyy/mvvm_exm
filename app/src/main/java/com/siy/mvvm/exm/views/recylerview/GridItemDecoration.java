 ...
 * 网格布局得分割线
 * <p>
 * Created by Siy on 2019/01/10.
 *
 * @author Siy
 * * @see <a href="https://www.jianshu.com/p/df4430c2a4a8">Android RecyclerView 的 网格布局 ItemDecoration</a>
 */
public class GridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (isLastRaw(parent, i, getSpanCount(parent), childCount) && !mBuilder.isShowLastDivider) {
                continue;
            }
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int bottom = child.getBottom() + params.bottomMargin + mBuilder.dividerHorSize;
